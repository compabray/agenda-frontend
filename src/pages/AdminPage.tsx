...
export default function AdminPage() {
  ...
  useEffect(() => {
    ...
    // Configurar header de autorización para las peticiones
    api.defaults.headers.common['Authorization'] = `Bearer ${token}`;
  }, [navigate]);

  const handleLogout = () => {
    // Limpiar token y redireccionar
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center">
          ...
          <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
            Desde aquí podrás gestionar las reservas, horarios, staff y configuraciones de tu negocio.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-600">Gestionar reservas y horarios disponibles</p>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-600">Administrar staff y horarios de trabajo</p>
              <div className="mt-4 text-xs text-gray-500">Próximamente...</div>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow">
              ...
              <p className="text-sm text-gray-600">Ajustar horarios y configuraciones generales</p>
              <div className="mt-4 text-xs text-gray-500">Próximamente...</div>
            </div>
          </div>
          ...
          <div className="mt-12 bg-blue-50 border border-blue-200 rounded-lg p-6 max-w-2xl mx-auto">
            <div className="flex items-start space-x-3">
              ...
              <div className="text-left">
                <h4 className="text-sm font-medium text-blue-900 mb-1">Dashboard en construcción</h4>
                <p className="text-sm text-blue-700">
                  Este es el panel de administración básico. Las funcionalidades completas de gestión 
                  de reservas, personal y configuraciones estarán disponibles próximamente.
                </p>
              </div>
            </div>
          </div>
