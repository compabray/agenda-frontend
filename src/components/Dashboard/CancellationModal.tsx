// src/components/Dashboard/CancellationModal.tsx
...
export default function CancellationModal({ 
  ...
  const handleConfirm = () => {
    setHasConfirmed(false); // Reset for next time
    onConfirm();
  };
          ...
          <div className="sm:flex sm:items-start">
            ...
            <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
              <h3 className="text-lg leading-6 font-medium text-gray-900">
                Cancelar turno de {customer.name}
              </h3>
              
              <div className="mt-2">
                <p className="text-sm text-gray-500">
                  Estás a punto de cancelar el turno de <strong>{customer.name}</strong>.
                </p>
                ...
                <div className="mt-4 p-4 bg-amber-50 border border-amber-200 rounded-lg">
                  <div className="flex items-start space-x-3">
                    ...
                    <div className="text-sm text-amber-800">
                      <p className="font-medium mb-1">¿Te aseguraste de avisar al cliente?</p>
                      <p>
                        Contactá a <strong>{customer.name}</strong> al teléfono{' '}
                        <a 
                ...
                <div className="mt-4">
                  <label className="flex items-start space-x-3">
                    ...
                    <span className="text-sm text-gray-600">
                      Confirmo que contacté al cliente para informarle sobre la cancelación del turno.
                    </span>
                  </label>
                </div>
              </div>
